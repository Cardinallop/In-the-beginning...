...
//  Calculator2
//
//  Created by Bobur Murtozaev on 10/4/17.
//  Copyright © 2017 BoburMurtozaev. All rights reserved.
//
...
struct CalculatorBrain {
    ...
    private var operations : Dictionary <String,Operation> = [
        ...
        "ran":Operation.nullaryOperation(
            { Double(arc4random()) / Double(UInt32.max)}, "random()"),
